    ...
    <body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
        <section class="contenido">
            ...
            <nav id="menu" class="navbar navbar-default navbar-fixed-top">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="navbar-header">
                           <img style="display:block; margin:auto;" width="110" height="55" src="logoba.png"/>
           ...
           <!-- ******************************************************************************************************************* -->
            ...
            <div class="contenido">
                <a href="../../../MenuIndividuales/Entradas/index.php" id="botonEnviar" class="mostrarmodal" tooltip="Traducir">
